...
class KISWebSocketProvider:
    ...
    def __init__(self, auth: KISAuth, is_virtual: bool = False):
        ...
        # Choose WebSocket endpoint (allow override for virtual/real)
        # Build WebSocket endpoint candidates (env override first)
    ...
    def _normalize_price_data(self, message: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            price_data = {
                ...
                "bid_price": int(body.get("askp", 0)),        # Ask price (bid for buyer)
                "ask_price": int(body.get("bidp", 0)),        # Bid price (ask for seller)
