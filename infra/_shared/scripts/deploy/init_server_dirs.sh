...
mkdir -p "${OBSERVER_ROOT}/config/scalp"
mkdir -p "${OBSERVER_ROOT}/config/swing"
mkdir -p "${OBSERVER_ROOT}/config/symbols"
mkdir -p "${OBSERVER_ROOT}/config/universe"
echo "  - config/{scalp,swing,symbols,universe} created"
...
mkdir -p "${OBSERVER_ROOT}/data/scalp"
mkdir -p "${OBSERVER_ROOT}/data/swing"
echo "  - data/{scalp,swing} created"
