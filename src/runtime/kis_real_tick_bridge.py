...
class KisRealTickBridge:
    ...
    def stream_envelopes(self) -> Iterator[TickEnvelope]:
    ...
    def to_snapshot_kwargs(self, env: TickEnvelope) -> Dict[str, Any]:
        """
