...
- 전체 스택(DB·앱·모니터링) 띄울 때: `infra/_shared/compose/docker-compose.prod.yml` + `infra/_shared/secrets/.env.prod` 기준

스크립트는 **프로젝트 루트**에서 호출하는 것을 전제로, 상대 경로로 compose/env를 지정하면 됩니다.
