...
⚠️ **주의: 본 문서의 `infra/scripts/` 참조는 deprecated되었습니다.**
- Terraform/infra 디렉토리가 제거되었습니다 (Design A 정책).
- SSH 검증은 현재 배포 프로세스에서 필요하지 않습니다.
- 본 문서는 아카이빙 목적으로 보존됩니다.

---

**버전:** v1.0.0 (Deprecated)  
**작성일:** 2026-01-11  
**적용:** QTS Observer 시스템 배포 및 운영 (레거시)  
